 ...
 * @author student
 */
public class JhofelsCoffe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("COFFE FOR SELL");

        jLabel12.setText("###");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "STARBUCKS", "CARIBOU", "NESPRESSO", "NESCAFE", "FOLGERS" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new JhofelsCoffe().setVisible(true);
        });
    }
