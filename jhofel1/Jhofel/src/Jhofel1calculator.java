 ...
 * @author AICS-CEBU
 */
public class Jhofel1calculator extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jhofel1calculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Jhofel1calculator().setVisible(true);
            }
        });
    }
